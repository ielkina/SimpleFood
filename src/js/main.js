...
function expand() {
  $(".user__form-btn").toggleClass("close");
  $(".user__form-input").toggleClass("square");
  if ($(".user__form-btn").hasClass("close")) {
    $(".user__form-input").focus();
  } else {
    $(".user__form-input").blur();
  }
}
$(".user__form-btn").on("click", expand);
